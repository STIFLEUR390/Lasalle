        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="input-group input-group-sm">
                        ...
                        <select wire:model='departement_search' class="mx-1 custom-select rounded-0">
                            <option value="">{{ trans_choice('Select a :name', 0, ['name' => __('department')]) }}</option>
                ...
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h4 class="modal-title">@lang("Edit a faculty")</h4>
                    ...
                    <div class="modal-body row">
                        ...
                        <div class="form-group col-md-6">
                            <div wire:ignore>
                                ...
                                <select id="select2-status" class="form-control @error('department_id') is-invalid @enderror"
                                    wire:model.defer='department_id' style="width: 100%;">
                                    <option value="">
                                        {{ trans_choice('Select a :name', 0, ['name' => __('department')]) }}</option>
                                    @foreach ($departments as $department)
                                        <option value="{{ $department->id }}">{{ $department->name }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="modal-footer justify-content-between">
                      ...
                      <button type="button" wire:click="updateFaculty" class="btn btn-primary">@lang('Update')</button>
                    </div>
                  </div>
                  <!-- /.modal-content -->
                </div>
            ...
            <div class="modal fade" id="modal-default">
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h4 class="modal-title">@lang("Add faculty")</h4>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    </div>
                    ...
                    <div class="modal-footer justify-content-between">
                      <button type="button" class="btn btn-danger" data-dismiss="modal">@lang("Close")</button>
                      <button type="button" wire:click="createFaculty" class="btn btn-primary">@lang('Save')</button>
                    </div>
                  </div>
                  <!-- /.modal-content -->
                </div>

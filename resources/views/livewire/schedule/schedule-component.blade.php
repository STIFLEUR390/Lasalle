                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($schedule->status == 'waiting')
                                            <span class="badge bg-info">@lang($schedule->status)</span>
                                        @endif

                                        @if ($schedule->status == 'finish')
                                            <span class="badge bg-success">@lang($schedule->status)</span>
                                        @endif

                                        @if ($schedule->status == 'in_progress')
                                            <span class="badge bg-warning">@lang($schedule->status)</span>
                                        @endif
